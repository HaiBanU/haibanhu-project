...
async function openInviteModal() {
    ...
    if (project.inviteCode) {
        ...
        // Thêm "haibanhu-project/" để tạo đường dẫn đúng trên GitHub Pages
        const joinURL = `${window.location.origin}/haibanhu-project/index.html?joinProject=${project.inviteCode}`;
